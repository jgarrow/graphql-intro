This project is intended as a walkthrough project for an introduction to [Apollo Server](https://www.apollographql.com/docs/apollo-server/) walkthrough stream.
